...
export const ButtonCV = () => {
  return (
    <button className=" bg-secondary hover:bg-secondary/90 px-8 py-2 rounded-full flexcenter gap-4">
      <span>Curriculo</span>
      <span className=" h-5 w-5 borde rounded-full flexcenter animate-bounce">
        <IoDocumentText />
      </span>
    </button>
  );
...
export const ButtonPixel = () => {
  return (
    <button className="group relative cursor-default w-[140px] h-[60px] bg-[linear-gradient(144deg,_#af40ff,_#5b42f3_50%,_#00ddeb)] text-white whitespace-nowrap flex flex-wrap rounded-lg overflow-hidden">
      ...
      <div className="w-[10px] h-[10px] blur-[5px] bg-[rgb(30,41,59)] delay-[0.2s] duration-[0.4s] hover:bg-transparent hover:delay-0 hover:duration-0 group-focus:bg-transparent delay-0.1"></div>
